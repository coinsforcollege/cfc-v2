...
const imageDir = path.join(__dirname, '../../public/images/submissions');
const docDir = path.join(__dirname, '../../public/documents/submissions');
const videoDir = path.join(__dirname, '../../public/videos/submissions');
