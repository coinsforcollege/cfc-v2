...
export const config = {
  light: vars({
    '--color-primary-0': '197 203 252',
    '--color-primary-50': '177 186 251',
    '--color-primary-100': '158 169 250',
    '--color-primary-200': '139 152 249',
    '--color-primary-300': '119 134 248',
    '--color-primary-400': '100 117 247',
    '--color-primary-500': '81 100 246',
    '--color-primary-600': '61 83 245',
    '--color-primary-700': '22 48 243',
    '--color-primary-800': '9 28 174',
    '--color-primary-900': '5 16 97',
    '--color-primary-950': '5 16 97',
    ...
    /* Tertiary */
    '--color-tertiary-0': '242 243 246',
    '--color-tertiary-50': '217 218 229',
    '--color-tertiary-100': '192 194 212',
    '--color-tertiary-200': '167 169 194',
    '--color-tertiary-300': '142 145 177',
    '--color-tertiary-400': '117 120 160',
    '--color-tertiary-500': '95 99 138',
    '--color-tertiary-600': '78 81 113',
    '--color-tertiary-700': '61 63 88',
    '--color-tertiary-800': '43 45 69',
    '--color-tertiary-900': '29 30 44',
    '--color-tertiary-950': '19 20 27',
  ...
  dark: vars({
    '--color-primary-0': '5 16 97',
    '--color-primary-50': '9 28 174',
    '--color-primary-100': '22 48 243',
    '--color-primary-200': '61 83 245',
    '--color-primary-300': '81 100 246',
    '--color-primary-400': '100 117 247',
    '--color-primary-500': '119 134 248',
    '--color-primary-600': '139 152 249',
    '--color-primary-700': '158 169 250',
    '--color-primary-800': '177 186 251',
    '--color-primary-900': '197 203 252',
    '--color-primary-950': '197 203 252',
