...
// Priority countries at top: US, UK, IN, CN

export interface CountryCode {
  code: string;      // ISO 3166-1 alpha-2 (US, GB, IN)
  name: string;      // Full name
  dialCode: string;  // Phone dial code (+1, +44, +91)
}
...
// Combined list with priority countries at top
export const COUNTRY_CODES: CountryCode[] = [...priorityCountries, ...otherCountries];
...
// Helper to find country by dial code (returns first match)
export const getCountryByDialCode = (dialCode: string): CountryCode | undefined => {
  return COUNTRY_CODES.find(c => c.dialCode === dialCode);
};

// Format for display: "+1 US"
export const formatCountryCodeDisplay = (country: CountryCode): string => {
  return `${country.dialCode} ${country.code}`;
};
