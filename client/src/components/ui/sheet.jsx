...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed bg-black/50",
        className
      )}
      style={{ zIndex: 1200, top: '64px', left: 0, right: 0, bottom: 0 }}
      {...props} />
  );
}
