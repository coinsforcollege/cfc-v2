...
const CollegeSelection = () => {
  ...
  const handleAddCollege = async (collegeId) => {
    try {
  ...
  const handleCreateAndAddCollege = async () => {
    try {
      ...
      >
        ...
        >
          ...
          <Button
            ...
            disabled={!newCollege.name || !newCollege.country || addingCollege === 'new'}
            variant="contained"
            size="large"
            sx={{
              background: 'linear-gradient(135deg, #8b5cf6 0%, #ec4899 100%)',
